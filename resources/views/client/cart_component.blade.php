    ...
    <div class="cart-check-out">
        <section class="h-100 h-custom" style="background-color: #d2c9ff;">
            <div class="container py-5 h-100  update_cart_url" data-url="{{ route('updateCart') }}">
                <div class="row d-flex justify-content-center align-items-center h-100 delete_cart_url"
                    data-url="{{ route('deleteCart') }}">
                    <div class="col-12">
                                ...
                                <div class="row g-0">
                                                ...
                                                @foreach ($carts as $id => $cart)
                                                    ...
                                                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                            <h6 class="mb-0">{{ $cart['price'] * $cart['quantity'] }}
                                                            </h6>
                                                        </div>
                                    ...
                                    <div class="col-lg-4 bg-grey">
                                        <div class="p-5">
                                            ...
                                            <a type="button" href="{{ route('check_out') }}"
        ...
        @else
            <p>Giỏ hàng của bạn đang trống. Hãy <a href="{{ route('product') }}">quay lại trang sản phẩm</a>.</p>
            @endif
        </section>
